<%-- 
    ...
    Created on : Nov 4, 2018, 4:24:57 PM
    Author     : DELL
--%>

<%@page import="java.sql.*, grades.Grades" %>
...
<html>
    ...
    <script>
        ...
        function validation() {
            ...
            var cla1 = document.forms["registration"]["cla1"].value;
            var cla2 = document.forms["registration"]["cla2"].value;
            ...
            var isClassValid = classValidation(cla1, cla2);
